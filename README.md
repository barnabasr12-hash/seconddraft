...
## V18 animations
- Added soft page-entry motion and scroll-triggered reveal animations.
- Cards, ministry items, service cards, leadership entries and timelines reveal with gentle stagger.
- Hero text animates on first view.
- Buttons and navigation have subtle interaction feedback.
- Church seal/logo gets a very slow floating motion.
- Daily Bible passage animates lightly when switching language.
- All animations respect `prefers-reduced-motion` for accessibility.
- Uses only CSS + vanilla JavaScript; no animation library or extra dependency.
