...
## V18 refined logo heroes
- Removed the awkward empty circular ornament and oversized background seal.
- Centered the church logo cleanly inside a subtle glass-style identity card.
- Kept the logo visually present without competing with the page heading.
- Improved the Ministries, Leadership & Legacy, and Connect hero sections on desktop, tablet, and mobile.

## V19 full logo visibility fix
- Fixed the inner-page logo being cropped inside the hero card.
- The issue came from the generic hero-image positioning rule applying to the logo.
- Ministries, Leadership & Legacy, and Connect now show the complete circular seal at the intended size.
